...
def load_fonts():
    try:
        return {
            "cfont": ImageFont.truetype("ANIYAXMUSIC/assets/cfont.ttf", 24),
            "tfont": ImageFont.truetype("ANIYAXMUSIC/assets/font.ttf", 30),
        }
...
YOUTUBE_IMG_URL = "https://files.catbox.moe/jjbbe8.jpg"
...
async def add_controls(img: Image.Image) -> Image.Image:
    ...
    region = img.crop(box)
    try:
        controls = Image.open("ANIYAXMUSIC/assets/controls.png").convert("RGBA")
